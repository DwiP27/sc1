...
const ow = 'DWI PUTRA';
const nomorowner = '085884275354';
const ovo = '085884275354';
const pulsa = '085884275354';
const dana = '085884275354';
const instagram = 'http://www.instagram.com/dwi.putra27';
const aktif = '08:00 - 22:00';
const vcard = 'BEGIN:VCARD\n'
  + 'VERSION:3.0\n'
  + 'FN:DWI PUTRA\n' // Nama kamu
  + 'ORG:DPSTORE ID;\n' // Nama bot
  + 'TEL;type=CELL;type=VOICE;waid=6285884275354:+62 858-8427-5354\n' //Nomor whatsapp kamu
  + 'END:VCARD'
//
const
  {
...
conn.on('qr', qr => {
  ...
  console.log(`[ ${moment().format("HH:mm:ss")} ] Dwibot Ready scan now!`);
});
...
setInterval(function () {
  for (i = 0; i < 3; i++) {
    console.log(`[ ${moment().format("HH:mm:ss")} ] => HI! I'm Dwi :)`)
  }
}, 15000)
...
╠════════════════════` , MessageType.text);
  ...
  if (text.includes('.Nulis')) {
    conn.sendMessage(id, 'Silakan ulangi command dengan huruf kecil\n_contoh : .nulis Dwi love udan_', MessageType.text, { quoted: m });
  }
  //Pengucapan ulang
  if (text.includes('.Say')) {
    conn.sendMessage(id, 'Silakan ulangi command dengan huruf kecil\n_contoh : .say Dwi gans_', MessageType.text, { quoted: m });
  }
  if (text.includes(".say")) {
  ...
  if (text.includes('.Thunder')) {
    conn.sendMessage(id, 'Silakan ulangi command dengan huruf kecil\n_contoh : .thunder Dwi_', MessageType.text, { quoted: m });
  }
  if (text.includes('.thunder')) {
  ...
  if (text.includes('.Sand1')) {
    conn.sendMessage(id, 'Silakan ulangi command dengan huruf kecil\n_contoh : .sand1 Dwi_', MessageType.text, { quoted: m });
  }
  if (text.includes('.sand1')) {
  ...
  if (text.includes('.Neon3d')) {
    conn.sendMessage(id, 'Silakan ulangi command dengan huruf kecil\n_contoh : .neon3d Dwi_', MessageType.text, { quoted: m });
  }
  if (text.includes('.neon3d')) {
  ...
  if (text.includes('.Blackpink')) {
    conn.sendMessage(id, 'Silakan ulangi command dengan huruf kecil\n_contoh : .Blackpink Dwi_', MessageType.text, { quoted: m });
  }
  if (text.includes('.blackpink')) {
  ...
  if (text.includes('.Cloud')) {
    conn.sendMessage(id, 'Silakan ulangi command dengan huruf kecil\n_contoh : .cloud Dwi_', MessageType.text, { quoted: m });
  }
  if (text.includes('.cloud')) {
  ...
  if (text.includes('.Sky')) {
    conn.sendMessage(id, 'Silakan ulangi command dengan huruf kecil\n_contoh : .sky Dwi_', MessageType.text, { quoted: m });
  }
  if (text.includes('.sky')) {
  ...
  if (text.includes('.Sand2')) {
    conn.sendMessage(id, 'Silakan ulangi command dengan huruf kecil\n_contoh : .sand2 Dwi_', MessageType.text, { quoted: m });
  }
  if (text.includes('.sand2')) {
  ...
  if (text.includes('.Sand3')) {
    conn.sendMessage(id, 'Silakan ulangi command dengan huruf kecil\n_contoh : .sand3 Dwi_', MessageType.text, { quoted: m });
  }
  if (text.includes('.sand3')) {
  ...
  if (text.includes('.Sand4')) {
    conn.sendMessage(id, 'Silakan ulangi command dengan huruf kecil\n_contoh : .sand4 Dwi_', MessageType.text, { quoted: m });
  }
  if (text.includes('.sand4')) {
  ...
  if (text.includes('.Balon')) {
    conn.sendMessage(id, 'Silakan ulangi command dengan huruf kecil\n_contoh : .balon Dwi_', MessageType.text, { quoted: m });
  }
  if (text.includes('.balon')) {
  ...
  if (text.includes('.Metal')) {
    conn.sendMessage(id, 'Silakan ulangi command dengan huruf kecil\n_contoh : .metal Dwi_', MessageType.text, { quoted: m });
  }
  if (text.includes('.metal')) {
  ...
  if (text.includes('.Old')) {
    conn.sendMessage(id, 'Silakan ulangi command dengan huruf kecil\n_contoh : .old Dwi_', MessageType.text, { quoted: m });
  }
  if (text.includes('.old')) {
  ...
  if (text.includes('.Holo')) {
    conn.sendMessage(id, 'Silakan ulangi command dengan huruf kecil\n_contoh : .holo Dwi_', MessageType.text, { quoted: m });
  }
  if (text.includes('.holo')) {
  ...
  if (text.includes('.Coding')) {
    conn.sendMessage(id, 'Silakan ulangi command dengan huruf kecil\n_contoh : .coding Dwi_', MessageType.text, { quoted: m });
  }
  if (text.includes('.coding')) {
  ...
  if (text.includes('.Neon4')) {
    conn.sendMessage(id, 'Silakan ulangi command dengan huruf kecil\n_contoh : .neon4 Dwi_', MessageType.text, { quoted: m });
  }
  if (text.includes('.neon4')) {
  ...
  if (text.includes('.Neon5')) {
    conn.sendMessage(id, 'Silakan ulangi command dengan huruf kecil\n_contoh : .neon5 Dwi_', MessageType.text, { quoted: m });
  }
  if (text.includes('.neon5')) {
...
Zulu = zu` , MessageType.text, { quoted: m });
  ...
  if (text.includes('.Rate')) {
    conn.sendMessage(id, 'Silakan ulangi command dengan huruf kecil\n_contoh : .rate seberapa ganteng Dwi_', MessageType.text, { quoted: m });
  ...
  if (text.includes('.Paper1')) {
    conn.sendMessage(id, 'Silakan ulangi command dengan huruf kecil\n_contoh : .paper1 Dwi_', MessageType.text, { quoted: m });
  }
  if (text.includes('.paper1')) {
  ...
  if (text.includes('.Block')) {
    conn.sendMessage(id, 'Silakan ulangi command dengan huruf kecil\n_contoh : .block Dwi_', MessageType.text, { quoted: m });
  }
  if (text.includes('.block')) {
  ...
  if (text.includes('.Heart')) {
    conn.sendMessage(id, 'Silakan ulangi command dengan huruf kecil\n_contoh : .heart Dwi_', MessageType.text, { quoted: m });
  }
  if (text.includes('.heart')) {
  ...
  if (text.includes('.Grass')) {
    conn.sendMessage(id, 'Silakan ulangi command dengan huruf kecil\n_contoh : .grass Dwi_', MessageType.text, { quoted: m });
  }
  if (text.includes('.grass')) {
  ...
  if (text.includes('.Ocean')) {
    conn.sendMessage(id, 'Silakan ulangi command dengan huruf kecil\n_contoh : .ocean Dwi_', MessageType.text, { quoted: m });
  }
  if (text.includes('.ocean')) {
  ...
  if (text.includes('.Board')) {
    conn.sendMessage(id, 'Silakan ulangi command dengan huruf kecil\n_contoh : .board Dwi_', MessageType.text, { quoted: m });
  }
  if (text.includes('.board')) {
  ...
  if (text.includes('.Mwolf')) {
    conn.sendMessage(id, 'Silakan ulangi command dengan huruf kecil\n_contoh : .mwolf Dwi_', MessageType.text, { quoted: m });
  }
  if (text.includes('.mwolf')) {
  ...
  if (text.includes('.Mglow')) {
    conn.sendMessage(id, 'Silakan ulangi command dengan huruf kecil\n_contoh : .mglow Dwi_', MessageType.text, { quoted: m });
  }
  if (text.includes('.mglow')) {
  ...
  if (text.includes('.Bit8')) {
    conn.sendMessage(id, 'Silakan ulangi command dengan huruf kecil\n_contoh : .bit8 Dwi_', MessageType.text, { quoted: m });
  }
  if (text.includes('.bit8')) {
  ...
  if (text.includes('.Hpotter')) {
    conn.sendMessage(id, 'Silakan ulangi command dengan huruf kecil\n_contoh : .Hpotter Dwi_', MessageType.text, { quoted: m });
  }
  if (text.includes('.hpotter')) {
  ...
  if (text.includes('.Pubg')) {
    conn.sendMessage(id, 'Silakan ulangi command dengan huruf kecil\n_contoh : .pubg Dwi_', MessageType.text, { quoted: m });
  }
  if (text.includes('.pubg')) {
  ...
  if (text.includes('.Cfire')) {
    conn.sendMessage(id, 'Silakan ulangi command dengan huruf kecil\n_contoh : .Cfire Dwi_', MessageType.text, { quoted: m });
  }
  if (text.includes('.cfire')) {
  ...
  if (text.includes('.Wface1')) {
    conn.sendMessage(id, 'Silakan ulangi command dengan huruf kecil\n_contoh : .Wface1 Dwi_', MessageType.text, { quoted: m });
  }
  if (text.includes('.wface1')) {
  ...
  if (text.includes('.Wface2')) {
    conn.sendMessage(id, 'Silakan ulangi command dengan huruf kecil\n_contoh : .Wface2 Dwi_', MessageType.text, { quoted: m });
  }
  if (text.includes('.wface2')) {
  ...
  if (text.includes('.Battlef')) {
    conn.sendMessage(id, 'Silakan ulangi command dengan huruf kecil\n_contoh : .Battlef Dwi_', MessageType.text, { quoted: m });
  }
  ...
  if (text.includes('.Lol')) {
    conn.sendMessage(id, 'Silakan ulangi command dengan huruf kecil\n_contoh : .lol Dwi_', MessageType.text, { quoted: m });
  }
  if (text.includes('.lol')) {
  ...
  if (text.includes('.Csgo')) {
    conn.sendMessage(id, 'Silakan ulangi command dengan huruf kecil\n_contoh : .csgo Dwi_', MessageType.text, { quoted: m });
  }
  if (text.includes('.csgo')) {
  ...
  if (text.includes('.Owatch')) {
    conn.sendMessage(id, 'Silakan ulangi command dengan huruf kecil\n_contoh : .Owatch Dwi_', MessageType.text, { quoted: m });
  ...
  if (text.includes('.Paper2')) {
    conn.sendMessage(id, 'Silakan ulangi command dengan huruf kecil\n_contoh : .paper2 Dwi_', MessageType.text, { quoted: m });
  }
  if (text.includes('.paper2')) {
  ...
  if (text.includes('.Coffee')) {
    conn.sendMessage(id, 'Silakan ulangi command dengan huruf kecil\n_contoh : .coffee Dwi_', MessageType.text, { quoted: m });
  }
  if (text.includes('.coffee')) {
  ...
  if (text.includes('.Shadow')) {
    conn.sendMessage(id, 'Silakan ulangi command dengan huruf kecil\n_contoh : .shadow Dwi_', MessageType.text, { quoted: m });
  ...
  if (text.includes('.Fontgen')) {
    conn.sendMessage(id, 'Silakan ulangi command dengan huruf kecil\n_contoh : .fontgen Dwi_', MessageType.text, { quoted: m });
  }
  if (text.includes(".fontgen")) {
  ...
  if (text.includes('.Alay')) {
    conn.sendMessage(id, 'Silakan ulangi command dengan huruf kecil\n_contoh : .alay Dwi sayang udan_', MessageType.text, { quoted: m });
  }
  if (text.includes(".alay")) {
  ...
  if (text.includes('.Stalk')) {
    conn.sendMessage(id, 'Silakan ulangi command dengan huruf kecil\n_contoh : .stalk @Dwidan_', MessageType.text, { quoted: m });
  }
  if (text.includes(".stalk")) {
  ...
  if (text.includes('.Namae')) {
    conn.sendMessage(id, 'Silakan ulangi command dengan huruf kecil\n_contoh : .namae Dwi_', MessageType.text, { quoted: m });
  }
  if (text.includes(".namae")) {
  ...
  if (text.includes('.Logopornhub')) {
    conn.sendMessage(id, 'Silakan ulangi command dengan huruf kecil\n_contoh : .logopornhub Dwi/nime_', MessageType.text, { quoted: m });
  }
  if (text.includes('.logopornhub')) {
  ...
  if (text.includes('.Ninja')) {
    ...
    conn.sendMessage(id, 'Silakan ulangi command dengan huruf kecil\n_contoh : .ninja Dwi/nime_', MessageType.text, { quoted: m });
  ...
  if (text.includes('.Wolf')) {
    conn.sendMessage(id, 'Silakan ulangi command dengan huruf kecil\n_contoh : .wolf Dwi/nime_', MessageType.text, { quoted: m });
  ...
  if (text.includes('.Lion')) {
    conn.sendMessage(id, 'Silakan ulangi command dengan huruf kecil\n_contoh : .lion Dwi/nime_', MessageType.text, { quoted: m });
  }
  if (text.includes('.lion')) {
  ...
  if (text.includes('.Glitch')) {
    conn.sendMessage(id, 'Silakan ulangi command dengan huruf kecil\n_contoh : .glitch Dwi/nime_', MessageType.text, { quoted: m });
  }
  if (text.includes('.glitch')) {
  ...
  if (text.includes('.Joker')) {
    conn.sendMessage(id, 'Silakan ulangi command dengan huruf kecil\n_contoh : .joker Dwi_', MessageType.text, { quoted: m });
  ...
  if (text.includes('.Blood')) {
    conn.sendMessage(id, 'Silakan ulangi command dengan huruf kecil\n_contoh : .blood Dwi_', MessageType.text, { quoted: m });
  ...
  if (text.includes('.Water')) {
    conn.sendMessage(id, 'Silakan ulangi command dengan huruf kecil\n_contoh : .water Dwi_', MessageType.text, { quoted: m });
  ...
  if (text.includes('.Neon')) {
    conn.sendMessage(id, 'Silakan ulangi command dengan huruf kecil\n_contoh : .neon2 Dwi_', MessageType.text, { quoted: m });
  ...
  if (text.includes('.Snow')) {
    conn.sendMessage(id, 'Silakan ulangi command dengan huruf kecil\n_contoh : .Snow Dwi_', MessageType.text, { quoted: m });
  }
  if (text.includes('.snow')) {
  ...
  if (text.includes('.Kata')) {
    conn.sendMessage(id, 'Silakan ulangi command dengan huruf kecil\n_contoh : .kata matamu indah bagai pelangi/Dwi_', MessageType.text, { quoted: m });
  }
  if (text.includes('.kata')) {
  ...
  if (text.includes('.Getzodiak')) {
    conn.sendMessage(id, 'Silakan ulangi command dengan huruf kecil\n_contoh : .getzodiak Dwi & 09-09-2009_', MessageType.text, { quoted: m });
  }
  if (text.includes('.getzodiak')) {
  ...
  if (text.includes('.Couple')) {
    conn.sendMessage(id, 'Silakan ulangi command dengan huruf kecil\n_contoh : .couple Dwi & udan_', MessageType.text, { quoted: m });
  }
  if (text.includes('.couple')) {
  ...
  if (text.includes('.Arti')) {
    conn.sendMessage(id, 'Silakan ulangi command dengan huruf kecil\n_contoh : .arti Dwi_', MessageType.text, { quoted: m });
  }
  if (text.includes(".arti")) {
...
╠════════════════════
╠≽ *.Kata (quotes/author)*
╠ _Ex = .Kata Aku cinta dia/Dwi_ 
╠≽ *.Logopornhub (teks1/teks2)*
╠ _Ex : .Logopornhub Dwi/nime_
╠≽ *.Lion (teks1/teks2)*
╠ _Ex : .Lion Dwi/nime_
╠≽ *.Ninja (teks1/teks2)*
╠ _Ex : .Ninja Dwi/nime_
...
╠ _Ex = .Arti Dwi_ 
╠≽️ *.Couple (Namamu & doi)*
╠ _Ex = .Couple Dwi & udan_ 
╠≽️ *.Getzodiak (Nama & tgl)
╠ _Ex : .Getzodiak Dwi & 09-09-2002_ 
